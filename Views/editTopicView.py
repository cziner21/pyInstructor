...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.editTopicNameBox = QtGui.QLineEdit(self.centralwidget)
        self.editTopicNameBox.setObjectName(_fromUtf8("editTopicNameBox"))
        self.horizontalLayout.addWidget(self.editTopicNameBox)
        ...
        self.horizontalLayout_2.addWidget(self.editTopicButton)
